...
-- شغّل هذا الملف مرة واحدة في Supabase SQL Editor قبل اختبار V141.
...
BEGIN
  ...
  -- غير المدير الرئيسي: يجب أن تكون صلاحية تغيير سعر البيع مفعلة، ولا يُسمح له بتغيير أي حقل آخر.
  IF v_exists AND NOT v_is_primary_manager THEN
    SELECT coalesce(tm.can_edit_sell_price,false)
